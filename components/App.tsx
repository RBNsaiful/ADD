    ...
    if (isSubScreen) {
        return (
            <header className="bg-light-bg dark:bg-dark-bg p-4 flex items-center justify-between sticky top-0 z-20 h-16 border-b border-gray-200 dark:border-gray-800 shadow-sm md:px-8 relative">
                {/* ROCK-STATIC CENTERED TITLE: Removed all animations, transitions, and 'keep-animating' classes. Absolute positioning ensures it never moves based on content below. */}
...
const App: FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center bg-gray-100 dark:bg-gray-900 font-sans overflow-y-scroll">
        ...
        {/* ROOT CONTAINER: Strictly static. overflow-y-scroll on the parent ensures the scrollbar is always visible, preventing horizontal 'jumps' of the centered header title. */}
